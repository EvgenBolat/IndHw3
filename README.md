...
Также стоит отметить, что так как задание выполнялось на Mac, то в тестовых файлах может возникнуть проблема с слэшами, их нужно просто исправить на слэши, используемые в вашей ОС (за неудобства приношу извинения, врать не стану, у меня при тестах на маке всё работало)
